        ...
        prices_per_person = [
            {
                ...
                "pricing": [
                    {
                        "time": str(time),
                        "price": get_base_price_signal_for_day(base_signal_db),
                    }
...
def submit_energy_consumption():
    ...
    for participant_info in req.get("values"):
        ...
        return {"acknowledged": "true", "acknowledgmentId": str(acknowledgment.id)}, 202
...
def get_points_with_base_points(acknowledgmentId):
    ...
    latest_energy_vector = get_all_instances_from_key(
        EnergyUsage, "ack_id", acknowledgmentId
    )
    ...
    base_points_and_earned_per_person = calculate_earned_points(
        latest_energy_vector, prices_per_person_vector, base_points_vector
    )
    ...
    return (
        {
            ...
            "status": "completed",
            "values": base_points_and_earned_per_person,
        },
        200,
    )
